...
public class EditDistance {
    ...
    private static int editDistance(String a,
                                    String b) {
        ...
        while (i + j > 0) {
            switch (x[i][j]) {
                case 1:
                    System.out.println("delete " + a.charAt(--j) + ";");
                    break;
                case 2:
                    System.out.println("insert " + b.charAt(--i) + ";");
                    break;
                case 3:
                    i--;
                    j--;
                    break;
                case 4:
                    System.out.println("replace " + a.charAt(--j) + " with " + b.charAt(--i) + ";");
                    break;
            }
        }
